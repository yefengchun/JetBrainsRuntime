...
@implementation MTLClip {
    ...
    id<MTLTexture> _aaStencilTextureRef;
}
...
- (void)copyFrom:(MTLClip *)other {
    ...
    _aaStencilTextureRef = other->_aaStencilTextureRef;
...
- (void)beginShapeClip:(BMTLSDOps *)dstOps context:(MTLContext *)mtlc {
    ...
    @autoreleasepool {
        ...
        id <MTLBuffer> buff = [mtlc.device newBufferWithLength:sizeX4 options:MTLResourceStorageModePrivate];
        ...
        [blitEncoder copyFromBuffer:buff
                ...
                sourceBytesPerImage:sizeX4
                         sourceSize:sourceSize
                          toTexture:dstOps->pAAStencilTexture
                   destinationSlice:0
                   destinationLevel:0
                  destinationOrigin:origin];
...
- (void)endShapeClip:(BMTLSDOps *)dstOps context:(MTLContext *)mtlc {
    ...
    @autoreleasepool {
        if (dstOps->width > 0 && dstOps->height > 0) {
            ...
            [blitEncoder copyFromTexture:dstOps->pAAStencilData
                             sourceSlice:0
                             sourceLevel:0
                            sourceOrigin:origin
                              sourceSize:sourceSize
                ...
                destinationBytesPerImage:sizeX4];
    ...
    _aaStencilTextureRef = dstOps->pAAStencilTexture;
